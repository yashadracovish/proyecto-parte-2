...
# J: Vértice del grafo — área con sus empleados y conexiones
class NodoArea:
...
# S: Grafo no dirigido; vértices = áreas, aristas = conexiones entre ellas
class GrafoEmpleados:

    def __init__(self):
        self.areas = {}

    # J: Agrega área si el código no existe
    ...
    # S: Elimina el vértice y limpia sus aristas en todos los demás nodos
    ...
    # J: Muestra datos, conexiones y empleados del área
    ...
    # J: Lista todas las áreas con empleados y conexiones
    ...
    # S: Arista bidireccional; evita duplicados en ambas listas de adyacencia
    ...
    # J: Elimina la conexión en ambas direcciones
    ...
    # S: Valida unicidad de cédula en todo el grafo antes de insertar
    ...
    # J: Busca la cédula en todas las áreas y elimina el empleado
    ...
    # J: Busca empleado por cédula y muestra sus datos
    ...
    # J: Lista los empleados de un área específica
    ...
    # S: Recorrido por niveles usando cola; marca visitados para no repetir nodos
    ...
    # S: Recorrido recursivo en profundidad; visitados se comparte entre llamadas
    ...
    # S: BFS que acumula la ruta en cada elemento de la cola para reconstruir el camino
...
def menu():
    # J: Inicializa el grafo con áreas y empleados de ejemplo
    ...
    # J: Bucle del menú hasta que el usuario elija salir
    while True:
        ...
        # J: Valida que la entrada sea un número
        try:
